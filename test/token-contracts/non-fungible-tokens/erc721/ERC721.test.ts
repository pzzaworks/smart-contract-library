...
describe("ERC721 Contract", () => {
    async function deployFixture() {
      ...
      const tokenContract = await ethers.deployContract("ERC721Contract", [
        "Name", 
        "Symbol", 
    ...
    describe("Mint", () => {
      it("Should mint tokens successfully", async () => {
        ...
        await tokenContract.mint(amount, { value: BigInt(value) });
      ...
      it("Should mint tokens if minting is enabled", async () => {
        ...
        await expect(tokenContract.mint(amount, { value: BigInt(value) })).to.be.revertedWith("Minting is currently disabled");
      });
      ...
      it("Should mint tokens if minting amount is more than zero", async () => {
        ...
        await expect(tokenContract.mint(amount, { value: BigInt(value) })).to.be.revertedWith("Not enough amount");
      });
      ...
      it("Should mint tokens if balance is more than mint price multiplyed by amount", async () => {
        ...
        await expect(tokenContract.mint(amount, { value: 0 })).to.be.revertedWith("Insufficient funds");
      });
      ...
      it("Should mint tokens if max supply limit is not exceeded", async () => {
        ...
        await expect(tokenContract.mint(amount, { value: BigInt(value) })).to.be.revertedWith("Max supply limit exceeded");
      });
      ...
      it("Should mint tokens if max mint amount per transaction is not exceeded", async () => {
        ...
        await expect(tokenContract.mint(amount, { value: BigInt(value) })).to.be.revertedWith("Max mint amount per transaction exceeded");
      });
      ...
      it("Should mint tokens if max mint amount per address is not exceeded", async () => {
        ...
        await expect(tokenContract.mint(amount, { value: BigInt(value) })).to.be.revertedWith("Max mint amount per address exceeded");
      });
  ...
  describe("Tokens Of Owner", () => {
    it("Should return the tokens of owner successfully", async () => {
      ...
      const tokensOfOwner = await tokenContract.tokensOfOwner(owner.address, 1, 5);
